...
<script type="text/javascript">
	$(document).ready(function() {
		jQuery("#jqgrid").jqGrid({
			...
			autowidth: true,
			shrinkToFit: false,
			colNames : ['Acciones', 'id', 'Nombres', 'Apellidos', 'Email','Contraseña','Ciudad', 'Telefono', 'Dirección'],
			colModel : [
			...
			{ name : 'Email', index : 'Email', align : "center", editable : true , width:"300px"}, 
			{ name : 'Contrasena', index : 'Contrasena', align : "center", editable : true,hidden:true , width:"200px"},
			{ name : 'Ciudad', index : 'Ciudad', align : "center", editable : true , width:"200px"},
			{ name : 'Telefono', index : 'Telefono', align : "center", editable : true , width:"200px"},
