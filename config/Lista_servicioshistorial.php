...
if(!empty($_POST))
{
    ...
    $result = mysql_query("SELECT * from Servicios where Cliente='$P' and Estado='Entregado' or Estado='Cancelado' or Estado='Rechazado'  order by IdServicio DESC") or die(mysql_error());
