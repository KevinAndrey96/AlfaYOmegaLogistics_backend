...
$page_title = "Mensajeros";
$page_css[] = "your_style.css";
include("inc/header.php");
$page_nav["Mensajeros"]["sub"]["Consultar"]["active"] = true;
include("inc/nav.php");
...
else
{
	...
	<div class="modal fade" id="search" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-den="true">
		<form name="" action="Mensajeros.php" method="GET" id="">
...
<script type="text/javascript">
	$(document).ready(function() {
		jQuery("#jqgrid").jqGrid({
			...
			if(!$_GET['buscar'])
			{
				echo 'url:"Data/data_mensajeros.php",';
			}else
			{
				echo 'url:"Busqueda/busqueda_mensajeros.php?buscar='.$_GET[buscar].'&en='.$_GET[en].'",';
			}
			?>
			datatype : "json",
			height : 'auto',
			...
			autowidth: true,
			shrinkToFit: false,
			colNames : ['Acciones', 'id', 'Documento','Nombres', 'Apellidos','Contraseña', 'Telefono', 'Direccion','Email', 'Credito','Ubicacion'],
			colModel : [
			{ name : 'act', index:'act', sortable:false, width:"100px" }, 
			{ name : 'id', index : 'id',editable : false ,hidden: true ,  align : "center",editable: false, width:"200px"}, 
			{ name : 'Documento', index : 'Documento',  align : "center",editable : true , width:"150px"}, 
			{ name : 'Nombres', index : 'Nombres',  align : "center",editable : true , width:"200px"}, 
			{ name : 'Apellidos', index : 'Apellidos', align : "center", editable : true , width:"200px"}, 
			{ name : 'Contrasena', index : 'Contrasena', align : "center", editable : true,hidden:true , width:"200px"},
			{ name : 'Telefono', index : 'Telefono', align : "center", editable : true , width:"150px"},
			{ name : 'Direccion', index : 'Direccion', align : "center", editable : true , width:"200px"},
			{ name : 'Email', index : 'Email', align : "center", editable : true , width:"200px"}, 
			{ name : 'Credito', index : 'Credito', align : "center", editable : false , width:"150px"},
			{ name : 'Ubicacion', index : 'Ubicacion', align : "center", editable : false , width:"200px"}
			],
			rowNum : 15,
			rowList : [15, 30, 45],
			pager : '#pjqgrid',
			...
			editurl : "Edit/edit_mensajeros.php",
			caption : "Mensajeros",
